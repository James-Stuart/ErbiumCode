...
##         burn_freq = 2.525*GHz
        ...
        windfreak(burn_freq, power, 'low', filepath, write = 1)
        pb.hole_burn(burn)
        record_trace2(SpecAn, filepath, compensated = 'Y', n=1, burn_time = burn)
...
##     full_off_set()    
##     burn_sequence(0.01, 2.54*GHz, 0)
##     burn_n_sit()
##     spin_pump_seq()
    SpecAn.write('SPan 2.9*GHz')
