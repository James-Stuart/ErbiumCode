...
#
def free_run_plot_window(compensated, centre = 1.45*GHz, span = 2.9*GHz, full_span = 'N'):
    global CB_state
    CB_state = False
    global get_axis_state
    get_axis_state = True
...
#
def free_run_plot_window_record(compensated, centre = 1.45*GHz, span = 0, full_span = 'N', record_length = 1*s):
...
#############CHOOSE ONE OF THE FOLLOWING TO EXECUTE###############
    ...
    #free_run_plot_window('Y', 1.45*GHz, 2.9*GHz) #choose 'Y' or 'N' to compensate  the plotted data 
